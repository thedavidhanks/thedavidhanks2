...
const FlowDiagram = ({ plan, dataset }) => {
    ...
    return (
        <section className="mb-4">
            <h3 className="h5">How it flows</h3>
            ...
            <div
                ...
                style={{ maxHeight: '34rem', overflow: 'auto', scrollMarginTop: '4.5rem' }}
                tabIndex={0}
                role="group"
            ...
            <ul className="list-unstyled small text-muted text-body-secondary mt-2 mb-0">
                {pooledCount > 0 && (
                    <li>

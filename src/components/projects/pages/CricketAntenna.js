...
const CricketAntenna = (props) => {
    ...
    <Container>
        ...
        <p>This antenna offers two methods of wireless connection: cellular and 
        ...
        <Carousel className="carouselContainer w-50">
          ...
          <h5>Bill of Material</h5>
            <ol>
                ...
                <li><a href="https://www.amazon.com/dp/B07V317BYF/ref=cm_sw_em_r_mt_dp_laBvFb3CQW62X">8.Cat6 RJ45 Shielded industrial panel mount</a></li>
                <li><a href="https://www.amazon.com/dp/B07LBRK94Q/ref=cm_sw_em_r_mt_dp_rhBvFbQBSMQW8">N-Male Bulkhead to TS9 female adapater</a></li>
                <li><a href="https://www.amazon.com/dp/B07LDZF3ZR/ref=cm_sw_em_r_mt_dp_5iBvFbX9BCDDD">5.5x2.5MM DC Power Plug</a></li>
                <li>10ga-ish power connectors</li>
                ...
                <li><a href="https://www.amazon.com/dp/B00X6BRR8I/ref=cm_sw_em_r_mt_dp_MnBvFb5BN3K8H">POE</a></li>
                <li>Hotspot with TS9 external cable connectors, like a MiFi 8800L, Qty 1</li>
                <li><a href="https://www.amazon.com/dp/B07SS6XTZY/ref=cm_sw_em_r_mt_dp_gpBvFbCC8Q0MX">USB Charging Module</a></li>
                <li>USB charging cable from (15) to (14)</li>
            </ol>
        <h5>Details</h5>
            <p>Power to the hotspot is supplied via a 12V source.  Generally this is
        in the form of a car battery.</p>
            <p>The cellular antenna is equipped with two MiMo 50Ohm directional 
        antenna that feature up to +10.6 dB gain.  </p>
        
        <h5>Installation Notes</h5>
        <ol>
            <li>Mount the two Wilson antennas 90 deg to each other for a Mult-In Multi-Out antenna.</li>
            <li>This is pretty much all the parts, less the 25' flag pole mast.  (link)  Not sure if it's cheaper/faster, but it may be.  It's also an example of how the antennas should be arranged.</li>
            <li>There may be some benefit in moving the control box (X) closer to the antenna array.
            I would expect less interference if the antenna cables
            were only 3' long and not as exposed to the power cables.  The 
            downside is the MiFi 8800L has a tendency to overheat
